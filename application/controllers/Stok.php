...
class Stok extends CI_Controller{
	...
	public function index(){
		$this->data['title'] = 'Data Stok Opname';
		$this->data['all_barang'] = $this->m_barang->lihat();
		$this->data['no'] = 1;

		$this->load->view('stok_opname/lihat', $this->data);
	}
	...
	public function ubah($kode_barang){
		...
		$this->load->view('stok_opname/ubah', $this->data);
	}
	...
	public function export(){
		$dompdf = new Dompdf();
		$this->data['all_barang'] = $this->m_barang->lihat();
		$this->data['title'] = 'Laporan Data Stok Opname';
		$this->data['no'] = 1;

		$dompdf->setPaper('A4', 'Landscape');
		$html = $this->load->view('stok_opname/report', $this->data, true);
