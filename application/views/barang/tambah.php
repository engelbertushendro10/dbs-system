						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
									<div class="form-group col-md-6">
											<label for="ukuran_barang"><strong>Ukuran Barang</strong></label>
											<input type="text" name="ukuran_barang" placeholder="Masukkan Ukuran Barang" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="satuan" placeholder="Masukkan Tipe" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<hr>
