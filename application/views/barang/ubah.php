							...
							<div class="card-body">
								<form action="<?= base_url('barang/proses_ubah/' . $barang->kode_barang) ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="satuan"><strong>Type</strong></label>
											<input type="text" name="satuan" placeholder="Masukkan Tipe" autocomplete="off"  class="form-control" required value="<?= $barang->satuan ?>">
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="ukuran_barang"><strong>Ukuran</strong></label>
											<input type="text" name="ukuran_barang" placeholder="Masukkan Ukuran" autocomplete="off"  class="form-control" required value="<?= $barang->ukuran_barang ?>">
										</div>
									</div>
									<hr>
