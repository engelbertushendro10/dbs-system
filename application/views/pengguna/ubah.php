								...
								<form action="<?= base_url('pengguna/proses_ubah/' . $pengguna->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode"><strong>Email Pengguna</strong></label>
											<input type="text" name="kode" placeholder="Masukkan KoEmail Pengguna" autocomplete="off"  class="form-control" required value="<?= $pengguna->kode ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
