							...
							<div class="card-body">
								<form action="<?= base_url('pengguna/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="kode"><strong>email</strong></label>
											<input type="text" name="kode" placeholder="Masukkan Kode Pengguna" autocomplete="off"  class="form-control" required value="PENGGUNA - <?= mt_rand(10, 99) ?>" maxlength="50">
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="nohp"><strong>No Hp</strong></label>
											<input type="number" name="nohp" placeholder="Masukan No Hp" autocomplete="off"  class="form-control" required maxlength="15">
										</div>
										<div class="form-group col-md-6">
											<label for="rule"><strong>Rule</strong></label>
											<input type="text" name="rule" placeholder="Masukan Role" autocomplete="off"  class="form-control" required> 
										</div>
									</div>
									<hr>
