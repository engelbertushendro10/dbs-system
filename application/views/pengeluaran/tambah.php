								...
								<form action="<?= base_url('pengeluaran/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										<div class="form-group col-2">
											<label>Invoice</label>
											<input type="text" name="no_keluar" value="" class="form-control" REQUIRED>
											<!-- TR <?= time() ?> -->
										</div>
									...
									<div class="row">
										<div class="col-md-3">
											...
											<div class="form-row">
												<div class="form-group col-10">
													...
													<input type="text" name="nama_customer" value="" id="nama_customer" class="form-control" REQUIRED>
										...
										<div class="col-md-9">
											...
											<div class="form-row">
												...
												<div class="form-group col-2">
													<label>Ukuran</label>
													<input type="text" name="ukuran_barang" value="" readonly class="form-control">
												</div>
		...
		$(document).ready(function(){
				...
				if($(this).val() == '') reset()
					...
					$.ajax({
						...
						success: function(data){
							...
							$('input[name="ukuran_barang"]').val(data.ukuran_barang)
			...
			$(document).on('click', '#tambah', function(e){
				...
				const data_keranjang = {
					...
					ukuran_barang: $('input[name="ukuran_barang"]').val(),
			...
			$('button[type="submit"]').on('click', function(){
				...
				$('input[name="ukuran_barang"]').prop('disabled', true)
			})
